...
// import mediaUrl.image("ep310.png") from "../img/ep310.png";
// import ProductBg from "../img/headerbackground.png";
// import productImage4 from "../img/EP310-4.png";
// import mediaUrl.doc("ep300.pdf") from "../img/ae200.pdf";
...
//               onClick={() => window.open(mediaUrl.doc("ep300.pdf"), "_blank")}  
//             >
//               Download Catalog
//             </button>
//           </>
...
//   const [productImage] = useState(mediaUrl.image("ep310.png"));
...
//       <img
//         src={mediaUrl.image("ep310.png")} /* or use any of your images like productImage2 */
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">DEVISER EP-310</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <h1 className="hero-title">EP-310</h1>
              <p className="hero-desc">
                Deviser EP‑310 PON power meters measure upstream and downstream PON signals at
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("ep300.pdf"), "_blank")}>
                  Download Catalog
                </button>
              </div>
