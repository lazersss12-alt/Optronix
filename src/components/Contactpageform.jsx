...
// import './Contact.css';
// import opticsphoto1 from './img/Opticalplant.png';
...
//     const content =
//       'Need Fiber Optic Cable, CATV, or Connectivity solutions? Contact Optronix India’s experts today! Find our head office address, phone numbers, and enquiry form.';
//     if (metaDescription) {
...
//         <p className="sub">
//           We understand every client’s need is different. whether you’re planning a new setup, upgrading equipment, or facing technical challenges.
...
//               <li><FiClock /> Monday to Saturday, 10:00 AM – 7:00 PM (GMT+5:30)</li>
//             </ul>
//           </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; margin:30px auto; background-color:#ffffff; border-radius:10px; box-shadow:0 3px 10px rgba(0,0,0,0.1);">
    ...
    <tr>
      <td style="padding:20px; text-align:center; background-color:#ffffff; border-top-left-radius:10px; border-top-right-radius:10px;">
        <img src={media_logo_webp} loading="lazy" alt="Candid Optronix Pvt. Ltd." style="max-width:180px; height:auto;">
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:25px 20px; color:#333333; line-height:1.6;">
        ...
        <p style="text-align:center; font-size:16px;">
          📞 <a href="tel:+919811308000" style="color:#004aad; text-decoration:none;">9811308000</a> | ✉️ <a href="mailto:info@optronix.in" style="color:#004aad; text-decoration:none;">info@optronix.in</a>
        </p>
    ...
    <tr>
      <td style="padding:20px; text-align:center; border-top:1px solid #e0e0e0; color:#555555; font-size:14px;">
        ...
        <p>📞 <a href="tel:+919811308000" style="color:#004aad; text-decoration:none;">9811308000</a> | ✉️ <a href="mailto:info@optronix.in" style="color:#004aad; text-decoration:none;">info@optronix.in</a><br>
        🌐 <a href="https://www.optronix.in" style="color:#004aad; text-decoration:none;">www.optronix.in</a></p>
      </td>
    </tr>
...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use URLSearchParams to ensure a simple request
    ...
    <section className="contact-page">
      ...
      <div className="contact-grid">
            ...
            <div className="form-field form-span-2">
              ...
              >
                ...
                <optgroup label="Fiber Optic Products">
                  ...
                  <option value="Drop Cables">Drop Cables</option>
                ...
                <optgroup label="Deviser Instruments">
                  ...
                  <option value="Deviser Spectrum Analyzer">Deviser Spectrum Analyzer</option>
                </optgroup>
        ...
        <div className="right-col">
          ...
          <div className="c-card distributor-cta">
            <h3>Interested in Partnership?</h3>
            <p>Join our growing network of authorized dealers across India.</p>
            <Link to="/become-a-distributor" className="btn-primary">
              Become a Distributor <FiExternalLink />
            </Link>
          </div>
        </div>
      </div>
