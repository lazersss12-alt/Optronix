...
// import media_Optronixgold_webp from "../img/Optronixgold.png"; // Replace with actual image if needed
// import media_GoldFibrediagram_webp from "../img/GoldFibrediagram.png"; // Replace with actual schematic image
...
//           <img src={media_GoldFibrediagram_webp} alt="Drop Cable Schematic Diagram" className="diagram-image" style={{ width: '820px', maxWidth: '100%', height: 'auto', margin: '0 auto', display: 'block' }} />
  ...
  return (
    <div className="s1v-page">
      ...
      <ProductLeadModal
        ...
        pageName="Optronix Fiber - Gold Series"
      />
    </div>
  );
};
