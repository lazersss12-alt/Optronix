...
const Optronixfiberproducttwelve = () => {
  ...
  return (
    <div>
      <div className='product_d'>
        <div className='product1_d1'>
            ...
            <div className='product1_d1_s1'>
                <h3 className='product1_d1_s1_name'>Neo <br/> Twelve Core Fiber (12F) </h3>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix Fiber - NEO 12F"
      />
    </div>
  )
}

export default Optronixfiberproducttwelve;