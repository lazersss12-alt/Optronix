...
const Optronixfiberproductnine = () => {
  ...
  return (
    <div>
      <div className='product_d'>
        <div className='product1_d1'>
            ...
            <div className='product1_d1_s1'>
                <h3 className='product1_d1_s1_name'>Neo <br/> Dual Core Fiber (2F) </h3>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix Fiber - NEO 2F"
      />
    </div>
  )
}

export default Optronixfiberproductnine;