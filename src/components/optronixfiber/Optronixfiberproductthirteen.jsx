...
const Optronixfiberproductthirteen = () => {
  ...
  return (
    <div>
      <div className='product_d'>
        <div className='product1_d1'>
            ...
            <div className='product1_d1_s1'>
                <h3 className='product1_d1_s1_name'>Optronix <br/> Drop Cable (2F) </h3>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix Fiber - Drop Cable 2F"
      />
    </div>
  )
}

export default Optronixfiberproductthirteen;