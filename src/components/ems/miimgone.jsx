    ...
    <div className="zigzag-container">
      ...
      <div className="right-collage">
        ...
        <div className="zigzag">
          <img src={media_mi1_webp} alt="img1" className="zigzag-img img1" />
          <img src={media_mi2_webp} alt="img2" className="zigzag-img img2" />
          <img src={media_mi3_webp} alt="img3" className="zigzag-img img3" />
          <img src={media_mi4_webp} alt="img4" className="zigzag-img img4" />
          <img src={media_mi5_webp} alt="img5" className="zigzag-img img5" />
        </div>
      </div>
    </div>
  );
