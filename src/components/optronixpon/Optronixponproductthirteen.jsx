...
// import mediaUrl.image("OP101X.png") from "../img/OP-101X.png";
...
const Optronixponproductthirteen = () => {
  ...
  const [productImage] = useState(mediaUrl.image("OP101X.png"));
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("op101x.pdf"), "_blank")}>
                  Download Catalog
                </button>
              </div>
