...
// import mediaUrl.image("fem router-01.png") from "../img/wifi8-removebg-preview.png";
...
//       <h1 className="hero-split__title">OP-841GWV-DGB</h1>
//       <p className="hero-split__desc">
//         The OP841GWV is a dual-mode XPON ONU with flexible deployment, 
...
//       <li>
//         <b>XPON Dual Mode</b>
//         <span> Supports both EPON and GPON with auto-detection and configuration.</span>
//       </li>
//       <li>
//         <b>High-performance WiFi</b>
//         <span> Dual band 802.11n/ac, enhanced FEM for better coverage.</span>
//       </li>
//       <li>
//         <b>Comprehensive QoS & Management</b>
//         <span> Full device management, IPv4/IPv6 support, and guaranteed QoS.</span>
//       </li>
//       <li>
//         <b>Plug and Play</b>
//         <span> Easy installation with auto-configuration convenience.</span>
//       </li>
//     </ul>
//   </div>
// </div>
...
//           <tr>
//             <td>LAN interface</td>
//             <td>4*GE, Auto-negotiation RJ45 connectors</td>
//           </tr>
//           <tr>
//             <td>Pots interface</td>
//             <td>1*FXS, RJ11 connector</td>
//           </tr>
//         </tbody>
//       </table>
//     </div>
...
//             Authentication: WEB/WAP-PSK(PTKIP)/WAP2-PSK(AES)<br />
  ...
  return (
    <div className="s1v-page">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("op841gwvd.pdf"), "_blank")}>
                  Download Catalog
                </button>
              </div>
          ...
          <div className="stack">
            <div className="panel" style={mosaicBG(0.92)}>
              ...
              <div style={{ marginTop: 12 }}>
                <button className="btn btn-primary" onClick={() => window.open("/contact", "_self")}>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PON - OP841GWV-D"
      />
    </div>
  );
};
