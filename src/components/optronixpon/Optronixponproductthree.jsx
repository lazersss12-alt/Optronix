...
//               <span>
//                 4 GE (copper) and 4 SFP/SFP+ uplink slots, 4 EPON OLT ports for downlink. Supports up to 256 ONUs (64 per PON port).
//               </span>
//             </li>
//             <li>
...
//                   Support PON Module level: Px20, Px20+, Px20++, Px20+++
//                 </td>
//               </tr>
//               <tr>
...
//             <thead>
//               <tr>
//                 <th colSpan={2}>Security Management / PON Port Specification</th>
//               </tr>
//               <tr>
//                 <th>Feature</th>
//                 <th>Description</th>
...
//             <thead>
//               <tr>
//                 <th colSpan={2}>Layer 2 Features</th>
//               </tr>
//               <tr>
//                 <th>Feature</th>
//                 <th>Description</th>
...
//             <thead>
//               <tr>
//                 <th colSpan={2}>Multicast / DHCP / Layer 3 Features</th>
//               </tr>
//               <tr>
//                 <th>Feature</th>
//                 <th>Description</th>
...
//               <tr>
//                 <td>OP-100P4</td>
//                 <td>4*EPON, 4*RJ45+4*SFP/(SFP+)</td>
//                 <td>1*AC Power + 1*BBU Interface</td>
//               </tr>
//             </tbody>
//           </table>
//         </div>
...
// export default Optronixponproductthree;
...
const Optronixponproductthree = () => {
  ...
  const [productImage] = useState(media_gpon4_webp);
  // Modal State
  ...
  useEffect(() => {
    document.title = 'Optronix OP-100P4G Layer 3 OLT: 4-Port GPON, OSPF/RIP';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Buy Optronix OP-100P4G, a Layer 3, 4-Port GPON OLT for FTTx. Supports OSPF/RIP Routing, 10GE Uplink, and carrier-class L2/L3 services (ITU-T G.984.x)';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">OPTRONIX OP-100P4G</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">OP-100P4G</h1>
              <p className="hero-desc">


                The OP-100P4G is a Layer 3 GPON Optical Line Terminal (OLT) in a compact pizza-box form factor, featuring 4 PON ports. It is designed for flexible and fast FTTx access, making it suitable for deployment in various scenarios.
              </p>
...
<<<<<<< HEAD
                <button className="btn btn-outline" onClick={() => window.open(media_OP_100P4G_pdf, "_blank")}>
=======
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("op-100p4g.pdf"), "_blank")}>
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
                  Download Catalog
                </button>
              </div>
          ...
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              ...
              <ul className="feature-list">
                ...
                <li>
                  <strong>Carrier-Class Security Protection:</strong> Support IEEE802.1x, Radius, Tacacs+.

                </li>
                <li>
                  <strong>Lower TCO:</strong> Support DHCP Snooping, DHCP Option82, IP Source Guard.

                </li>
                <li>
                  <strong>Architecture:</strong> 4-Port Layer 3 GPON OLT.
                </li>
                <li>
                  <strong>High Scalability:</strong> Supports a high splitting ratio (typically 1:128 per PON port).
                ...
                <li>
                  <strong>Compact Design:</strong> 1U 19-inch standard box—small size and lightweight.

                </li>
                <li>
                  <strong>Advanced L3 Routing:</strong> Supports RIPv1/v2, OSPFv2/v3, and Static Route.
                ...
                <li>
                  <strong>Security & Redundancy:</strong> Supports LACP, STP, RSTP for uplink protection and carrier-class security features.
                  ...
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Uplink Ports</td>
                          <td>2xGE (RJ45 Copper) + 2xSFP/SFP+ Slots</td>
                        </tr>
                        <tr><td>PON Standard</td><td>Compliant with ITU-T G.984.x</td></tr>


                        <tr><td>PON Speed</td><td>Downstream: 2.5Gbps, Upstream: 1.25Gbps</td></tr>

                        <tr><td> Connector</td><td>SC/UPC </td></tr>
                        <tr>
                          <td>Dimensions (LxWxH)</td>
                          <td>442mm×229mm×43.6mm</td>
                        </tr>
                        <tr>
                          <td>Power Consumption</td>
                          <td>35W</td>
                ...
                <div className="acc-content">
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        <tr><td>Layer 3 (L3)</td><td>Static Route, Dynamic Route (RIPv1/v2, OSPFv2/v3), RIPng </td></tr>
                        <tr><td>L3 Routing</td><td>4096 Hardware Host Routes, 512 Hardware Subnet Routes</td></tr>

                        <tr><td>Layer 2 (L2)</td><td>Port-based Rate Limitation, RSTP, Port VLAN, Separation, Dynamic Bandwidth Allocation (DBA) </td></tr>
                        <tr><td>VLAN</td><td>VLAN tag/Un-tag, Transparent Transmission </td></tr>
                        <tr><td>Multicast</td><td>IGMP Snooping, 2048 IP Multicast Groups, MLD v1/v2 snooping </td></tr>
                        <tr><td>DHCP</td><td>DHCP Server, DHCP Relay, DHCP Snooping, Option82 </td></tr>
                        <tr><td>QoS</td><td>Based on Port, VID, TOS, and MAC Address; SP, WRR </td></tr>
                        <tr><td>Security</td><td>Radius, Tacacs+, IP Source Guard, ACL (IPv4 & IPv6), 802.1x</td></tr>
                        <tr><td>IPv6</td><td>NDP, IPv6 Ping, IPv6 Telnet, IPv6 Routing, IPv6 ACL</td></tr>
                        <tr><td>Management</td><td>SNMP, Telnet, CLI, WEB, SSH v2, OMCI, TR069 </td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
...
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PON - OP-100P4G"
      />
    </div>
  );
};
