...
// import media_gpon4_webp from "../img/op2.png";
=======
...
// import mediaUrl.image("gpon4.webp") from "../img/op2.png";
...
//       <h1 className="hero-split__title">OP-100P4</h1>
...
//       <img
//         src={media_gpon4_webp} /* or use any of your images like productImage2 */
...
//           <table className="universal-table">
//             <thead>
//               <h3>Security Management / PON Port Specification</h3>
//               <br></br>
//               <tr>
//                 <th>Feature</th>
//                 <th>Description</th>
...
//           <table className="universal-table">
//             <thead>
//               <h3>Multicast / DHCP / Layer 3 Features</h3>
//               <br></br>
//               <tr>
//                 <th>Feature</th>
//                 <th>Description</th>
...
//     <img className='product_s1v1_img' src={media_gpon4_webp} alt="FC8R" />
...
// export default Optronixponproductfive;
...
const Optronixponproductfive = () => {
  ...
  useEffect(() => {
    document.title = 'Optronix: OP-100P4 Layer 3 OLT: 4-Port EPON, 256 ONU';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Buy Optronix OP-100P4, a Layer 3, 4-Port EPON OLT. Supports 256 ONUs, 4 GE Uplink, RIP/OSPF Routing, and full L2/L3 services for Triple Play.';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        ...
        <nav className="breadcrumb">
          ...
          <span className="current">OPTRONIX OP-100P4</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <h1 className="hero-title">OP-100P4</h1>
              <p className="hero-desc">
                The Optronix OP-100P4 series EPON OLT is a Layer 3 Optical Line Terminal designed for efficient network deployment. It features a 1U height, 19-inch rack-mount form factor , making it suitable for deployment in compact room environments.
              </p>
          ...
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              ...
              <ul className="feature-list">
                <li>
                  <strong>Configuration:</strong> 4-Port Layer 3 EPON OLT.
                </li>
                <li>
                  <strong>High Density:</strong> Supports 256 ONUs in total (64 ONUs per PON port).
                </li>
                <li>
                  <strong>Uplinks:</strong> Provides 4 GE (copper) + 4 SFP/SFP+ slots.
                </li>
                <li>
                ...
                <li>
                  <strong>Comprehensive IPv6 Support:</strong> Includes IPv6 Static/Dynamic Route, DHCPv6, and MLD v1/v2.
                </li>
                <li>
                  <strong>Advanced Management:</strong> Managed via SNMP, Telnet, CLI, WEB, and SSH v2.
                </li>
              </ul>
                  ...
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        ...
                        <tr><td>Downlink Ports</td><td>4xEPON OLT Ports (SFP Slots)</td></tr>
                        <tr><td>PON Splitting Ratio</td><td>1:64 (Max)</td></tr>
                        <tr><td>PON Module Level</td><td>Px20, Px20+, Px20++, Px20+++</td></tr>
                        <tr><td>PON Speed</td><td>Symmetrical 1.25Gbps</td></tr>
                        <tr><td>PON Wavelength</td><td>TX-1490nm, RX-1310nm </td></tr>
                        <tr><td>PON Connector</td><td>SC/UPC, 9/125µm SMF </td></tr>
                        <tr>
                        ...
                        <tr>
                          <td>Power Supply</td>
                          <td>AC 100~240 V, 50/60 Hz; DC: -48V</td>
                        </tr>
                        <tr>
                          <td>Dimensions (LxWxH)</td>
                          <td>442mm*200mm*43.6mm</td>
                        </tr>
                  ...
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        ...
                        <tr><td>L3 Routing</td><td>1024 Hardware Host Routes, 512 Hardware Subnet Routes </td></tr>
