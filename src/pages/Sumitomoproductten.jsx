import media_SFCS_webp from '../assets/img2/img/SFCS.webp';
import media_Backup_of_Z2C_2june_webp from '../assets/img2/img/Backup_of_Z2C 2june.webp';
import media_W1C_file_webp from '../assets/img2/img/W1C file.webp';
import media_82C__1Oct_2024_webp from '../assets/img2/img/82C+ 1Oct 2024.webp';
import media_FC8r_webp from '../assets/img2/img/FC8r.webp';
// import React, { useState } from 'react';
// import './page.css';
// import { Link } from 'react-router-dom';
// import media_SFCS_webp from "../components/sumitomo/img-s/SFCS.png";
// import s1vpdf from "../components/img/cleaver.pdf";
...
// import productImage3 from "../components/img/SFCS3.png";
// import eponoltf1 from "../components/img/sfcsb.png";
// import media_Backup_of_Z2C_2june_webp from "../components/img/Backup_of_Z2C 2june.png";
// import media_W1C_file_webp from "../components/img/W1C file.png";
// import media_82C__1Oct_2024_webp from "../components/img/82C+ 1Oct 2024.png";
// import media_FC8r_webp from "../components/img/FC8r.png";
...
//         Sumitomo <span className="highlight" style={{color:"#3c5a9f"}}>SFCS Metal Cleaver</span><br></br>
//         For Single Fiber
//       </>
//     ),
//     img: media_SFCS_webp
...
//         <span className="highlight" style={{color:"#364bd8"}}>Durability</span>  on the Go-
...
//   }
// ];
// const Sumitomoproductten = () => {
//   const [productImage, setProductImage] = useState(media_SFCS_webp);
...
//       <h1 className="hero-split__title">SUMITOMO SFCS</h1>
//       <p className="hero-split__desc">
//         Discover the Sumitomo SFCS Fusion Splicer – a high-precision, compact powerhouse crafted by
...
//         features and a user-friendly design, the SFCS ensures efficient, flawless splicing in any environment.
//       </p>
...
//       <img
//         src={media_SFCS_webp} /* or use any of your images like productImage2 */
...
//           <tr className="section-header">
//             <td colSpan={2} rowSpan={2}> Cleave Length *1</td>
//           </tr>
...
//           <tr className="section-header">
//             <td colSpan={2} rowSpan={2}>Size <sup>*2</sup></td>
//           </tr>
...
//                       <img className='product_s1v1_img' src={media_Backup_of_Z2C_2june_webp} alt="Z2C" />
...
//                       <img className='product_s1v1_img' src={media_82C__1Oct_2024_webp} alt="82C+" />
...
//                       <img className='product_s1v1_img' src={media_W1C_file_webp} alt="W1C" />
...
//                       <img className='product_s1v1_img' src={media_FC8r_webp} alt="FC8R" />
...
// export default Sumitomoproductten;
...
const Sumitomoproductten = () => {
  ...
  const [productImage] = useState(media_SFCS_webp);
  // Modal State
  ...
  useEffect(() => {
    document.title = 'Sumitomo SFC-S Precision Fiber Cleaver';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Optronix offers the rugged Sumitomo SFC-S metal cleaver for high-precision, single-fiber preparation. Features a 12-step blade with a 60,000-fiber life and simple slide operation.';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">SFCS</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">SUMITOMO SFCS</h1>
              <p className="hero-desc">
                Sumitomo SFCS is a single‑fiber metal cleaver designed for precise, repeatable cleaves.
                It features a premium 12‑step blade and ships in a strong protective box — ideal for
                reliable field work.
              </p>
        ...
        {activeTab === 'overview' && (
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              <h3 className="panel-title">Why SFCS stands out</h3>
              <p className="tabs-note">Explore the SFCS from a quick overview to full technical details and accessories.</p>

              <ul className="feature-list">
                <li>Single‑fiber metal cleaver for precise, repeatable results.</li>
                <li>Premium 12‑step blade for long service life.</li>
                <li>Strong protective box for safe transport.</li>
                <li>Stable cleaving mechanism ensuring consistent fiber quality.
                </li>
                <li>Compact, lightweight design for easy field handling.</li>
                <li>Precision alignment system for accurate single-fiber placement.</li>
                <li>Low-maintenance structure with simple cleaning access.
                </li>
                <li>Smooth operation requiring minimal hand-force.</li>
                <li>Durable metal construction engineered for long-term reliability.</li>
                <li>Ideal for FTTH, backbone, and data-center fiber prep.</li>
                <li>Compatible with standard fiber holders and workflows.</li>
                <li>Blade engineered for minimal fiber waste and high repeatability.
                </li>
                ...
                <div className="perf-table-wrap">
                  <table className="perf-table">
                    <tbody>
                      ...
                      <tr>
                        <th>Use case</th>
                        <td>Single‑fiber cleaving in a protective box</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <details className="acc" open>
                ...
                <div className="acc-content">
                  <div className="acc-kv-list">
                    {/* Applicable fiber */}
                    <div className="kv acc-kv"><span className="k">Material</span><span className="v">Silica</span></div>
                    ...
                    <div className="kv acc-kv"><span className="k">Dimensions & weight</span><span className="v">51(W) × 106(D) × 83(H) mm; Approx. 260 g</span></div>
      ...
      <section className="container similar-wrap similar--pro">
        ...
        <div className="s-grid">
          <div className="s-card">
            ...
            <div className="s-media"><img src={media_Backup_of_Z2C_2june_webp} loading="lazy" alt="Z2C" /></div>
          ...
          <div className="s-card">
            <span className="s-brand">SUMITOMO</span>
            <div className="s-media"><img src={media_82C__1Oct_2024_webp} loading="lazy" alt="82C+" /></div>
            <div className="s-body">
          ...
          <div className="s-card">
            <span className="s-brand">SUMITOMO</span>
            <div className="s-media"><img src={media_W1C_file_webp} loading="lazy" alt="W1C" /></div>
            <div className="s-body">
          ...
          <div className="s-card">
            <span className="s-brand">SUMITOMO</span>
            <div className="s-media"><img src={media_FC8r_webp} loading="lazy" alt="FC8R" /></div>
            <div className="s-body">
