...
// import subfc6s from "../components/img/FC-6S.png";
...
//   const [productImage, setProductImage] = useState(media_FC8r_webp);
...
//       <img
//         src={media_FC8r_webp} /* or use any of your images like productImage2 */
...
//                       <img className='product_s1v1_img' src={subfc6s} alt="FC-6S" />
...
const Sumitomoproductseven = () => {
  ...
  const [productImage] = useState(media_FC8r_webp);
  // Modal State
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(media_FC8R_pdf, "_blank")}>
                  Download Catalog
                </button>
              </div>
