...
export default function BranchesPage() {
  ...
  const eventData = location.state?.eventData ?? [
    ...
    { id: 3, title: 'Kolkata', subtitle: 'Cable TV Show India', cover: mediaUrl.image("img11.webp"), images: [mediaUrl.image("img11.webp"), mediaUrl.image("img12.webp"), mediaUrl.image("img13.webp"), mediaUrl.image("img14.webp")] },
    { id: 4, title: 'Kalyan', subtitle: 'Free Service Camp - Technical Support', cover: mediaUrl.image("freeservicecamp1.webp"), images: [mediaUrl.image("freeservicecamp1.webp"), mediaUrl.image("freeservicecapm2.webp"), mediaUrl.image("freeservicecamp3.webp")] }
  ];
