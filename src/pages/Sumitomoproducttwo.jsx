...
// import media_s1vuf_webp from "../components/img/s1vuf.png";
...
// import media_sumitomos1vu_pdf from "../components/img/sumitomos1vu.pdf";
...
// //               onClick={() => window.open(media_sumitomos1vu_pdf, "_blank")}  
// //             >
// //               Download Catalog
// //             </button>
// //           </>
...
//   const [productImage, setProductImage] = useState(media_s1vuf_webp);
...
//       <img
//         src={media_s1vuf_webp} /* or use any of your images like productImage2 */
...
const Sumitomoproducttwo = () => {
  ...
  const [productImage] = useState(media_s1vuf_webp);
  // Modal State
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(media_sumitomos1vu_pdf, "_blank")}>
                  Download Catalog
                </button>
              </div>
