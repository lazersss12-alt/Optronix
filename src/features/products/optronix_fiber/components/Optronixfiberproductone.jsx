...
//   //     <img loading="lazy" src={mediaUrl.image("flat cable .webp")} alt="Drop Cable Schematic Diagram" className="diagram-image" style={{ width: '820px', maxWidth: '100%', height: 'auto', margin: '0 auto', display: 'block' }} />
...
//   //     <img loading="lazy" className='product_s1v1_img' src={mediaUrl.image("fiber cable.webp")} alt="OP-100P8G" />
