...
import bannerImage from '../../../../assets/images/Fbanner.jpeg'; // Using the same banner image as PON
import ProductLeadModal from '../../../../components/common/ProductLeadModal';

import productimage from "../../../../assets/images/Optronixgold (2).png";
import productgold from "../../../../assets/images/Optronixgold.png";
import productneo from "../../../../assets/images/OptronixNeo.png";
import flatcable from "../../../../assets/images/DC.png";
import productdropcable from '../../../../assets/images/DC.png';
import goldproduct from "../../../../assets/images/GOLDFIBER.pdf";
import neoproduct from "../../../../assets/images/NEOFIBER.pdf";
import platinumproduct from "../../../../assets/images/PLATINUMFIBER.pdf";
import dropcableproduct from "../../../../assets/images/dropcablef.pdf";
  ...
  return (
    <div className="optronixfiberproduct-page-main">
      ...
      <ProductLeadModal
        ...
        pageName={`Optronix Fiber – ${enquireModal}`}
      />
