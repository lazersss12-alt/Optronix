...
<<<<<<< HEAD
// import media_Optronixgold_webp from "../../../../assets/images/Optronixgold.png"; // Replace with actual image if needed
// import media_GoldFibrediagram_webp from "../../../../assets/images/GoldFibrediagram.png"; // Replace with actual schematic image
...
// import media_GOLDFIBER_pdf from "../../../../assets/images/GOLDFIBER.pdf";
// const Optronixfiberproductfour = () => {
//    const [productImage, setProductImage] = useState(media_Optronixgold_webp);
//   const [enquireOpen, setEnquireOpen] = useState(false);
=======
// import mediaUrl.image("optronixgold.webp") from "../../../../assets/images/Optronixgold.png"; // Replace with actual image if needed
// import mediaUrl.image("goldfibrediagram.webp") from "../../../../assets/images/GoldFibrediagram.png"; // Replace with actual schematic image
...
// import mediaUrl.doc("goldfiber.pdf") from "../../../../assets/images/GOLDFIBER.pdf";
// const Optronixfiberproductfour = () => {
//    const [productImage, setProductImage] = useState(mediaUrl.image("optronixgold.webp"));
  const [enquireOpen, setEnquireOpen] = useState(false);
...
//       <h1 className="hero-split__title">Optronix Gold</h1>
...
<<<<<<< HEAD
//           onClick={() => window.open(media_GoldFibrediagram_webp, "_blank")}
=======
//           onClick={() => window.open(mediaUrl.image("goldfibrediagram.webp"), "_blank")}
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
//         >
//           Download Catalog
//         </button>
...
//       <img
<<<<<<< HEAD
//         src={media_Optronixgold_webp} /* or use any of your images like productImage2 */
=======
//         src={mediaUrl.image("optronixgold.webp")} /* or use any of your images like productImage2 */
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
...
//               <tr>
//                 <td>HDPE Coating</td>
//                 <td>Super / Super Double Coating</td>
//               </tr>
//               <tr>
//                 <td>Yarn Count</td>
//                 <td>1200 TEX</td>
...
//                 <td>2/3 Nos. (0.8mm / 1mm) - FRP Embedded in Sheath</td>
//               </tr>
//               <tr>
//                 <td>Outer Jacket</td>
...
<<<<<<< HEAD
//           <img loading="lazy" src={media_GoldFibrediagram_webp} alt="Drop Cable Schematic Diagram" className="diagram-image" style={{ width: '820px', maxWidth: '100%', height: 'auto', margin: '0 auto', display: 'block' }} />
=======
//           <img loading="lazy" src={mediaUrl.image("goldfibrediagram.webp")} alt="Drop Cable Schematic Diagram" className="diagram-image" style={{ width: '820px', maxWidth: '100%', height: 'auto', margin: '0 auto', display: 'block' }} />
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
...
//               </tr>
//               <tr>
//                 <td>Max. Tensile Strength: 350 N (Short Term)</td>
//                 <td>Cable Diameter: 5.8mm / 6mm / 6.5mm / 7mm</td>
//               </tr>
//               <tr>
...
// export default Optronixfiberproductfour;
...
<<<<<<< HEAD
  const [productImage] = useState(media_Optronixgold_webp);
=======
  const [productImage] = useState(mediaUrl.image("optronixgold.webp"));
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
  const [enquireOpen, setEnquireOpen] = useState(false);
  ...
  useEffect(() => {
    document.title = 'OPTRONIX GOLD SERIES Unitube SM G.652D Fiber Optic Cable (2F-12F)';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'The OPTRONIX GOLD SERIES is a high-performance, un-armoured Unitube cable (2F-12F). Featuring SM G.652D fiber, low $\le0.4~dB/Km$ attenuation 1, and $350~N$ tensile strength2. Ideal for reliable FTTx and LAN deployment.';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">Optronix Gold</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">Optronix Gold</h1>
              <p className="hero-desc"> The GOLD Series is engineered to deliver high-performance optical transmission with superior coating, enhanced durability, and excellent long-term reliability for FTTx, enterprise, and metro networks.</p>
...
<<<<<<< HEAD
                <button className="btn btn-outline" onClick={() => window.open(media_GOLDFIBER_pdf, "_blank")}>
=======
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("goldfiber.pdf"), "_blank")}>
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
                  Download Catalog
                </button>
              </div>
        ...
        {activeTab === 'overview' && (
          <div className="panel" style={mosaicBG(0.92)}>
            ...
            <ul className="feature-list">
              <li>ITU-T G.652D compliant single-mode fibre with excellent transmission stability</li>
              <li>Super Double HDPE coating for superior environmental protection</li>
              <li>GOLD fiber Technical Sheet</li>
              <li>Low attenuation: ≤0.4 dB/km @ 1310 nm, ≤0.2 dB/km @ 1550 nm</li>
              <li>GOLD fiber Technical Sheet</li>
              <li>UV-cured FRP strength members for improved tensile performance</li>
              <li>PBT loose tube with thixotropic jelly for full fibre isolation and moisture blocking</li>
              <li>Wide operating temperature: −20°C to +70°C</li>
              <li>Lightweight build for easy handling and faster installation</li>
              <li>Available in 2F, 4F, 6F, 12F configurations</li>
            </ul>
                ...
                content: (
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        {/* Transmission */}
                        <tr><td>Transmission</td><td>@ 1310 nm</td><td>≤0.4 dB/km</td></tr>
                        <tr><td>Transmission</td><td>@ 1550 nm</td><td>≤0.2 dB/km</td></tr>
                        ...
                        <tr>
                          <td>Geometrical</td>
                          <td>Mode Field Diameter @ 1550 nm</td>
                          <td>10.3 ± 0.5 µm</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>Fibre Cut Off Wavelength</td>
                          <td>≤1320 nm</td>
                        </tr>
                        <tr>
                          <td>Cut Off Wavelength</td>
                  ...
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        <tr>
                          <td>Cable Type</td>
                          <td>UNITUBE Un-Armoured Optical Fibre Cable</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>Change in attenuation ≤0.05 dB/km (IEC Standard)</td>
                        </tr>

                        <tr>
                          <td>Cable Diameter</td>
                          <td>5.8mm / 6mm / 6.5mm / 7mm</td>
                        </tr>
