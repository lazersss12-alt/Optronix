...
import Optronixfiberpro from '../components/Optronixfiberpro';
import Optronixfiberproduct from '../components/Optronixfiberproduct';
  ...
  return (
    <div>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix Fiber Optic Cables"
      /></div>
  );
};
