...
// import media_vfl_webp from "../../../../assets/images/vfl.png";
// import ProductBg from "../../../../assets/images/headerbackground.png";
// import productImage4 from "../../../../assets/images/VF10-4.png";
// import media_vf10_pdf from "../../../../assets/images/vf10.pdf";
// import productImage2 from "../../../../assets/images/VF10-2.png";
// import productImage3 from "../../../../assets/images/VF10-3.jpg";
// import z2cImg from "../../../../assets/images/ae3100_main.jpg";
// import c82Img from "../../../../assets/images/ep710.png";
...
//          <span className="highlight" style={{color:"#3c5a9f"}}>VF10 VFL -</span> Pocket - <br></br>

//          Size Power For Fast<br></br>
...
//         <span className="highlight" style={{color:"#3c5a9f"}}>Built for Accurate</span><br></br>
//         <span className="highlight" style={{color:"#3c5a9f"}}>Fiber Spotting</span><br></br>


//         <br></br>
//         <h6>2.5mm Universal Connector + 650nm Precision</h6>
//       </>
//     ),
//     img: productImage2,
...
//         <span className="highlight" style={{color:"#3c5a9f"}}>Spot Fiber Faults</span><br></br>
//         <span className="highlight" style={{color:"#3c5a9f"}}>Clearly</span><br></br>

//         <br></br>

//         <h6>Up to 10km with VF-10 Precision.</h6>
//       </>
//     ),
//     img: productImage3,
//   },
...
//         <br></br>
//         <h6>5+ Hours on Just 2x AA Batteries(Backlight Off).</h6>
//       </>
//     ),
//     img: productImage4,
//     buttons: (
...
//               onClick={() => window.open(media_vf10_pdf, "_blank")}  
//             >
//               Download Catalog
//             </button>
//           </>
...
// const [productImage] = useState(media_vfl_webp);
...
//       <h1 className="hero-split__title">VF-10 VFL - Pocket Size Fiber Fault Locator</h1>
//       <p className="hero-split__desc">
//         Discover the Deviser VF-10 VFL – a high-precision, compact powerhouse crafted by
...
//         features and a user-friendly design, the VF-10 ensures efficient, flawless splicing in any environment.
//       </p>
...
//       <img
//         src={media_vfl_webp} /* or use any of your images like productImage2 */
...
//         <tr>
//           <td>Interface</td>
//           <td>PC, 2.5mm universal connector</td>
//         </tr>
//         <tr>
//           <td>Environment</td>
//           <td>Operation temperature [-10 ~ +60°C]; Storage temperature [-20 ~ +70°C]</td>
//         </tr>
//         <tr>
//           <td>Battery life</td>
//           <td>~5 hours at 700mAh; 2x AAA batteries</td>
//         </tr>
//         <tr>
//           <td>Dimensions</td>
//           <td>5.1" x 1.2" x 0.7" (130mm x 30mm x 18mm)</td>
//         </tr>
//         <tr>
//           <td>Weight</td>
//           <td>&lt; 4.5oz (120g)</td>
...
// export default Deviserproductnine;
...
const Deviserproducteight = () => {
  ...
  useEffect(() => {
    document.title = 'Optronix: Deviser VF-10 Visual Fault Locator | 10mW, 10km Range';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'The Optronix Deviser VF-10 VFL is a compact, 10mW Visual Fault Locator with a 650nm laser and 2.5mm universal connector. Quickly detect fiber breaks, bends, and splices up to 10km.';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">DEVISER VF-10 VFL</span>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <h1 className="hero-title">VF-10 VFL</h1>
              <p className="hero-desc">
                The Deviser VF‑10 is a compact, precise visual fault locator designed for fast fiber fault
                detection. With a 650 nm laser, 2.5 mm universal connector, and up to 10 km range, VF‑10 helps
                you quickly spot breaks, bends, and splices in the field.
              </p>
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(media_vf10_pdf, "_blank")}>
                  Download Catalog
                </button>
              </div>
        ...
        {activeTab === 'overview' && (
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              <h3 className="panel-title">Why VF‑10 stands out</h3>
              <p className="panel-sub">
                Pocket‑sized, precise fiber fault detection with long battery life.
              </p>
              <ul className="feature-list">
                <li>2.5 mm universal connector for quick hook‑up.</li>
                <li>650 nm visible laser for clear fault indication.</li>
                <li>Up to ~10 km detection range.</li>
                <li>Rugged, field‑ready design.</li>
                <li>~5 hours operation on 2×AAA (700 mAh).</li>
                <li>Detects breaks, bends, bad splices, and connector faults instantly.
                </li>
                <li>Compatible with SM/MM fibers for versatile field use.</li>
                <li>Stable output power for consistent fault visibility.</li>
                <li>Continuous and pulsed modes for flexible detection needs.</li>
                <li>Clearly visible laser even in bright outdoor conditions.</li>
                <li>Durable metal emitter head for long service life.
                </li>
                <li>Simple one-button operation for quick testing.</li>
              ...
              <div className="panel side" style={mosaicBG(0.90)}>
                ...
                <div className="perf-table-wrap">
                  <table className="perf-table">
                    <tbody>
                      <tr><th>Wavelength</th><td>650 ± 10 nm</td></tr>
                      <tr><th>Output power</th><td> 10 mW</td></tr>
                      <tr><th>Operation modes</th><td>CW; 1 Hz</td></tr>
            ...
            <div className="acc-group">
              ...
              <details className="acc" open>
                <summary className="acc-sum">
                  <span className="acc-title">Visual Fault Locator (VFL) — Specifications</span>
                </summary>
                ...
                <div className="acc-content">
                  <div className="acc-table">
                    ...
                    <div className="acc-row"><span>Wavelength</span><span>650 ± 10 nm</span></div>
                    <div className="acc-row"><span>Emitter type</span><span>FP</span></div>
                    <div className="acc-row"><span>Output power</span><span>10 mW</span></div>
                    <div className="acc-row"><span>Operation modes</span><span>CW; 1 Hz</span></div>
                    <div className="acc-row"><span>Interface</span><span>PC, 2.5 mm universal connector</span></div>
                    <div className="acc-row"><span>Environment</span><span>Operating: −10 ~ +60 °C; Storage: −20 ~ +70 °C</span></div>
                    <div className="acc-row"><span>Battery life</span><span>~5 hours at 700 mAh; 2×AAA batteries</span></div>
                    <div className="acc-row"><span>Dimensions</span><span>5.1″ × 1.2″ × 0.7″ (130 × 30 × 18 mm)</span></div>
                    <div className="acc-row"><span>Weight</span><span>4.5 oz (120 g)</span></div>
