...
//   const [productImage, setProductImage] = useState(media_S_70_png);
...
//       <img
//         src={media_S_70_png} /* or use any of your images like productImage2 */
...
const Sumitomoproducteight = () => {
  ...
  const [productImage] = useState(media_S_70_png);
  // Lightbox state
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(media_S_70_pdf, "_blank")}>
                  Download Catalog
                </button>
              </div>
