import media_OP821GWV_D_png from '../../../../assets/img2/img/OP821GWV-D.png';
import media_op821GwV_Dp_png from '../../../../assets/img2/img/op821GwV-Dp.png';
import media_OP821GWV_D_removebg_preview_png from '../../../../assets/img2/img/OP821GWV-D-removebg-preview.png';
import media_Op821GWV_png from '../../../../assets/img2/img/Op821GWV.png';
import media_OP821GW_png from '../../../../assets/img2/img/OP821GW.png';
...
// import OP821GWV_D from "../../../../assets/images/OP821GWV-D-removebg-preview.webp";
// import optronixDiagram821GWV from "../../../../assets/images/Application Chart.webp";
// 
// import op821GwV_Dp from '../../../../assets/images/op821GwV-Dp.webp';
// import OP821GWV_D_removebg from '../../../../assets/images/OP821GWV-D-removebg-preview.webp';
// import Op821GWV from '../../../../assets/images/Op821GWV.webp';
// import OP821GW from '../../../../assets/images/OP821GW.webp';
...
//           <h2 className="highlights-title" style={{ marginLeft: '20px' }}>Key Highlights</h2>
...
//     <img loading="lazy" className='product_s1v1_img' src={media_op821GwV_Dp_png} alt="Z2C" />
...
//     <img loading="lazy" className='product_s1v1_img' src={media_OP821GWV_D_removebg_preview_png} alt="82C+" />
...
//     <img loading="lazy" className='product_s1v1_img' src={media_Op821GWV_png} alt="W1C" />
...
//     <img loading="lazy" className='product_s1v1_img' src={media_OP821GW_png} alt="FC8R" />
...
// export default Optronixponproductten;
...
const Optronixponproductten = () => {
  ...
  useEffect(() => {
    document.title = 'Optronix: OP821GWV-D XPON ONT: 2GE+1POTS, WiFi5 HGU';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Buy Optronix OP821GWV-D Dual-Mode XPON ONT (EPON/GPON) for FTTH. Features 2GE, 1POTS VoIP, and 1200Mbps Dual-Band WiFi5 (802.11ac). Supports SIP and Easy Mesh.';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        ...
        <nav className="breadcrumb">
          ...
          <span className="current">OPTRONIX OP-821GW-D</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <h1 className="hero-title">OP-821GW-D</h1>
              <p className="hero-desc">
                The OP821GW-D is a 2GE+1POTS+WiFi5 XPON HGU ONT (Home Gateway Unit Optical Network Terminal). It is a broadband access device specifically designed to meet the needs of fixed network operators for FTTH (Fiber to the Home) and comprehensive triple-play services.
              </p>
              ...
              <div className="cta-row">
                ...
                <button className="btn btn-outline" onClick={() => window.open(media_op821gwv_pdf, "_blank")}>
                  Download Catalog
                </button>
              </div>
          ...
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              ...
              <ul className="feature-list">
                ...
                <li><strong>PON Mode:</strong> Automatically detects and exchanges PON Mode</li>
