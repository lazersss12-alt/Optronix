import media_OP100P8G_removebg_preview_webp from '../../../../assets/img2/img/OP100P8G-removebg-preview.webp';
import media_Gepon_8G_webp from '../../../../assets/img2/img/Gepon 8G.webp';
import media_gpon4_webp from '../../../../assets/img2/img/gpon4.webp';
import media_op1_webp from '../../../../assets/img2/img/op1.webp';
...
import media_OP100P8G_removebg_preview_pdf from '../../../../assets/img2/img/media/images/OP100P8G-removebg-preview.png';
// import React from 'react';
// import './Optronixponproduct.css';
// import '../../../../pages/page.css';
// import { Link } from 'react-router-dom';
<<<<<<< HEAD
// import media_OP100P8G_removebg_preview_webp from "../../../../assets/images/OP100P8G-removebg-preview.png"; // Use your actual image path
...
// import media_op2_webp from "../../../../assets/images/op2.png";
=======
// import mediaUrl.image("op100p8g-removebg-preview.webp") from "../../../../assets/images/OP100P8G-removebg-preview.png"; // Use your actual image path
// import op08pdf from "../../../../assets/images/OP100P8G.pdf";
...
//       <h1 className="hero-split__title">OP-100P16G</h1>
//       <p className="hero-split__desc">
//         The OP-100P16G is a pizza-box GPON OLT with 16 GPON ports that meets flexible 
...
//       <img
<<<<<<< HEAD
//         src={media_OP100P8G_removebg_preview_webp} /* or use any of your images like productImage2 */
=======
//         src={mediaUrl.image("op100p8g-removebg-preview.webp")} /* or use any of your images like productImage2 */
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
...
//       <li>
//         <b>Compact design, versatile applications</b>
//         <p>
//           Supports deployment in diverse scenarios including low density areas, 
//           remote areas, sparsely-populated areas and industry parks. Supports 
//           FTTM and sharing site/rack with wireless base stations.
//         </p>
//       </li>
//       <li>
//         <b>Small size and lightweight</b>
//         <p>
//           Easy to transport and install. Supports multiple installation modes, 
//           like limited room space, basement, low-voltage room and small rack or cabinet.
//         </p>
//       </li>
//       <li>
//         <b>Carrier-class security protection</b>
//         <p>
//           Supports uplink redundancy protection including LACP STP, RSTP and MSTP, 
//           and support RIP & OSPF protocol. Supports link protection.
//         </p>
//       </li>
//       <li>
//         <b>Lower TCO</b>
//         <p>
//           Dramatically saves on investment fees in trunk fibers, pipe engineering, 
//           and facilities. Effectively reduces CapEx and OpEx.
//         </p>
//       </li>
//     </ul>
//   </div>
...
//             </thead>
//             <tbody>
//               <tr><td>Management Function,SNMP, Telnet, CLI, WEB, SSH v2</td><td></td></tr>
...
//     <img loading="lazy" className='product_s1v1_img' src={media_gpon4_webp} alt="82C+" />
...
//     <img loading="lazy" className='product_s1v1_img' src={media_op1_webp} alt="W1C" />
...
//     <img loading="lazy" className='product_s1v1_img' src={media_op2_webp} alt="FC8R" />
...
// export default Optronixponproductone;
...
<<<<<<< HEAD
  const [productImage] = useState(media_OP100P8G_removebg_preview_webp);
=======
  const [productImage] = useState(mediaUrl.image("op100p8g-removebg-preview.webp"));
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
  ...
  useEffect(() => {
    document.title = 'Optronix OP-100P16G Layer 3 OLT: 16-Port GPON, 10GE Uplink';

    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Buy Optronix OP-100P16G, a Layer 3, 16-Port GPON OLT for large FTTx networks. Features OSPF/RIP Routing, 10GE Uplink, and robust L2/L3 services (ITU-T G.984.x).';
    ...
    <div className="s1v-page">
      ...
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">OPTRONIX OP-100P16G</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">OP-100P16G</h1>
              <p className="hero-desc">
                The OP-100P16G is a carrier-grade, high-capacity Layer 3 GPON Optical Line Terminal (OLT). It is housed in a standard 1U 19-inch rack-mount chassis and features an impressive 16 GPON ports.
              </p>
...
<<<<<<< HEAD
                <button className="btn btn-outline" onClick={() => window.open(media_OP100P8G_removebg_preview_pdf, "_blank")}>
=======
                <button className="btn btn-outline" onClick={() => window.open(mediaUrl.doc("op100p8g-removebg-preview.pdf"), "_blank")}>
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
                  Download Catalog
                </button>
              </div>
          ...
          <div className="panel-grid">
            <div className="panel" style={mosaicBG(0.92)}>
              ...
              <ul className="feature-list">
                ...
                <li>
                  <strong>Security:</strong> Carrier-Class Security Protection
                </li>
                <li>
                ...
                <li>
                  <strong>Density:</strong> 16-Port Layer 3 GPON OLT.

                </li>

                <li>
                  <strong>High Density:</strong>  Supports a high splitting ratio — typically 1:128 per PON port for large user coverage.

                </li>

                <li>
                  <strong>Uplinks:</strong> Features 4 GE (copper) and 4 SFP/SFP+ (10GE) slots (8 slots total).

                </li>

                <li>
                  <strong>High Capacity:</strong> 128 Gbps Backplane Bandwidth.

                </li>

                <li>
                  <strong>Full L3 Routing Support:</strong> Supports dynamic protocols RIPv1/v2 and OSPFv2/v3, plus Static Route

                </li>

                <li>
                  <strong>Security & Redundancy:</strong> Supports LACP, STP, RSTP, MSTP for uplink redundancy.
                ...
                <li>
                  <strong>Management:</strong> Managed via SNMP, Telnet, CLI, WEB, and SSH v2, with OMCI support.
                ...
                <div className="perf-table-wrap">
                  <table className="perf-table">
                    <tbody>
                      ...
                      <tr><th>Connector</th><td>SC/UPC</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
                ...
                <div className="acc-content">
                  <div className="table-wrapper">
                    <table className="universal-table">
                      ...
                      <tbody>
                        <tr><td>Product Type</td><td>Layer3 16 Ports GPON OLT</td></tr>
                        ...
                        <tr><td>Downlink Ports</td><td>16x GPON OLT Ports</td></tr>
...
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
          ...
          <div className="s-card">
            <span className="s-brand">OPTRONIX</span>
            <div className="s-media"><img src={media_gpon4_webp} loading="lazy" alt="OP-100P4G" /></div>
            <div className="s-body">
          ...
          <div className="s-card">
            <span className="s-brand">OPTRONIX</span>
            <div className="s-media"><img src={media_op1_webp} loading="lazy" alt="OP100P8" /></div>
            <div className="s-body">
...
>>>>>>> 54d7a995d80297b97eaf55eeeca00ce44db276fc
      ...
      {lightboxOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Product image (zoomed)"
