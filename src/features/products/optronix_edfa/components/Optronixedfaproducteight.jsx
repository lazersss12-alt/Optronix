...
const Optronixedfaproducteight = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix PE0819M-OSW PON EDFA | 8 Port Amplifier with Optical Switch</title>
        <meta name="description" content="Optronix PE0819M-OSW: 8 port PON EDFA with integrated WDM and Optical Switch. Delivers 19.5dBm per port with SNMP management for reliable FTTH." />
        <meta name="keywords" content="Optronix PE0819M-OSW, PON EDFA with Optical Switch, 8 Port EDFA, WDM EDFA, 1550nm Amplifier, CATV EDFA, SNMP EDFA, Optronix India." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">PON EDFA PE0819M+OSW</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">PON EDFA PE0819M+OSW</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE0819M-OSW PON EDFA"
      /></div>
  );
};

export default Optronixedfaproducteight;
