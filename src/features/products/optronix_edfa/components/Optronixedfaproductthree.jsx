...
import op08 from "../../../../assets/images/CE0816M.png";

import subz2c from "../../../../assets/images/CE0416M.png";
import subw1c from "../../../../assets/images/CE0419M.png";
import sub82c from "../../../../assets/images/PE0819M.png";
import subfc8r from "../../../../assets/images/PE1619M.png";
import ProductLeadModal from '../../../../components/common/ProductLeadModal';


const Optronixedfaproductthree = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix CE0819M 1550nm CATV EDFA | 8 Port 19.5dBm Amplifier</title>
        <meta name="description" content="Optronix CE0819M: High-performance 1550nm CATV EDFA with 8 ports and 19.5dBm output. Features SNMP management, redundant power supply, and low noise for FTTH." />
        <meta name="keywords" content="Optronix CE0819M, 19.5dBm EDFA, CATV EDFA, 8 Port Optical Amplifier, 1550nm EDFA, Optronix India, Fiber Optic Amplifier, SNMP EDFA, CATV Headend Equipment." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">CATV EDFA CE0819M</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">CATV EDFA CE0819M</h1>
            ...
            <div className="hero-right">
              ...
              >
                <img loading="lazy" src={productImage} alt="CE0819M" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container similar-wrap similar--pro">
        ...
        <div className="s-grid">
          <div className="s-card">
            ...
            <div className="s-media"><img loading="lazy" src={subz2c} alt="CE0416M" /></div>
          ...
          <div className="s-card">
            <span className="s-brand">OPTRONIX</span>
            <div className="s-media"><img loading="lazy" src={subw1c} alt="CE0419M" /></div>
            <div className="s-body">
          ...
          <div className="s-card">
            <span className="s-brand">OPTRONIX</span>
            <div className="s-media"><img loading="lazy" src={sub82c} alt="PE0819M" /></div>
            <div className="s-body">
          ...
          <div className="s-card">
            <span className="s-brand">OPTRONIX</span>
            <div className="s-media"><img loading="lazy" src={subfc8r} alt="PE1619M" /></div>
            <div className="s-body">
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE0819M 1550nm CATV EDFA"
      /></div>
  );
};

export default Optronixedfaproductthree;
