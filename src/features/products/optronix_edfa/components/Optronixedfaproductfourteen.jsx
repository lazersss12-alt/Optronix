...
import op08 from "../../../../assets/images/CE1 619M.png";
  ...
  const [enquireOpen, setEnquireOpen] = useState(false);
    ...
    return (
        <div className="s1v-page">
            <Helmet>
                <title>Optronix CE1619M-OSW | 16 Port 1550nm EDFA with Optical Switch</title>
                <meta name="description" content="Optronix CE1619M-OSW: 1550nm CATV EDFA with 16 ports, 19.5dBm output, and integrated Optical Switch. Features SNMP, redundant power, and low noise for FTTH." />
                <meta name="keywords" content="Optronix CE1619M-OSW, 16 Port EDFA with Optical Switch, 1550nm Optical Amplifier, 19.5dBm EDFA, CATV EDFA, SNMP EDFA, Optronix India, Fiber Amplifier." />
            </Helmet>
            {/* Breadcrumbs */}
            <div className="container">
                <nav className="breadcrumb">
                    ...
                    <span className="current">CATV EDFA CE1619M+OSW</span>
                </nav>
            </div>
                ...
                <div className="hero-card" style={mosaicBG(0.92)}>
                    <div className="hero-grid">
                        ...
                        <div className="hero-left">
                            <h1 className="hero-title">CATV EDFA CE1619M+OSW</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE1619M-OSW"
      /></div>
    );
};

export default Optronixedfaproductfourteen;
