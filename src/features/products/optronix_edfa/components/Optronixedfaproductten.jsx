...
import op08 from "../../../../assets/images/PE3219M.png";
  ...
  const [enquireOpen, setEnquireOpen] = useState(false);
    ...
    return (
        <div className="s1v-page">
            <Helmet>
                <title>Optronix PE3219M-OSW PON EDFA | 32 Port Amplifier with Optical Switch</title>
                <meta name="description" content="Optronix PE3219M-OSW: 32 port PON EDFA with integrated WDM and Optical Switch. High-density solution with 19.5dBm output and full network management." />
                <meta name="keywords" content="Optronix PE3219M-OSW, 32 Port PON EDFA, Optical Switch EDFA, WDM EDFA, 1550nm Amplifier, CATV EDFA, SNMP EDFA, Optronix India." />
            </Helmet>
            {/* Breadcrumbs */}
            <div className="container">
                <nav className="breadcrumb">
                    ...
                    <span className="current">PON EDFA PE3219M+OSW</span>
                </nav>
            </div>
                ...
                <div className="hero-card" style={mosaicBG(0.92)}>
                    <div className="hero-grid">
                        ...
                        <div className="hero-left">
                            <h1 className="hero-title">PON EDFA PE3219M+OSW</h1>
                        ...
                        <div className="hero-right">
                            ...
                            >
                                <img loading="lazy" src={productImage} alt="PE3219M" />
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE3219M-OSW PON EDFA"
      /></div>
    );
};

export default Optronixedfaproductten;
