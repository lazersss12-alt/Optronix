...
const Optronixedfaproductone = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix CE0416M 1550nm CATV EDFA | 4 Port Optical Amplifier</title>
        <meta name="description" content="Optronix CE0416M 1550nm EDFA with 4 output ports & 16.5dBm power. Features SNMP web management, redundant power supplies, and low noise for CATV networks." />
        <meta name="keywords" content="Optronix CE0416M, CATV EDFA, 1550nm Optical Amplifier, 4 Port EDFA, 16.5dBm EDFA, Fiber Optic Amplifier, SNMP EDFA, Optronix India, CATV Headend." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">CATV EDFA CE0416M</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">CATV EDFA CE0416M</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE0416M CATV EDFA"
      />
    </div>
  );
};

export default Optronixedfaproductone;
