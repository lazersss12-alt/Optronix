...
const Optronixedfaproductseven = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix PE3219M PON EDFA | 32 Port 1550nm WDM Amplifier</title>
        <meta name="description" content="Optronix PE3219M: High-density 32 port PON EDFA with WDM for large-scale FTTH deployments. Features 19.5dBm output, SNMP, and redundant power." />
        <meta name="keywords" content="Optronix PE3219M, 32 Port PON EDFA, WDM EDFA, 1550nm Optical Amplifier, CATV EDFA, High Density EDFA, SNMP EDFA, Optronix India." />
      </Helmet>
      {/* Breadcrumbs */}
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE3219M PON EDFA"
      /></div>
  );
};
