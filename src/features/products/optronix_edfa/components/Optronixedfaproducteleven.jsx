...
import op08 from "../../../../assets/images/CE0416M.png";
...
const Optronixedfaproducteleven = () => {
  ...
  const [enquireOpen, setEnquireOpen] = useState(false);
    ...
    return (
        <div className="s1v-page">
            <Helmet>
                <title>Optronix CE0416M-OSW | 4 Port 1550nm EDFA with Optical Switch</title>
                <meta name="description" content="Optronix CE0416M-OSW: 1550nm CATV EDFA with 4 ports, 16.5dBm output, and built-in Optical Switch. Features SNMP, redundant power, and low noise for FTTH." />
                <meta name="keywords" content="Optronix CE0416M-OSW, EDFA with Optical Switch, 4 Port EDFA, 1550nm Optical Amplifier, 16.5dBm EDFA, CATV EDFA, SNMP EDFA, Optronix India, Fiber Amplifier." />
            </Helmet>
            {/* Breadcrumbs */}
            <div className="container">
                <nav className="breadcrumb">
                    ...
                    <span className="current">CATV EDFA CE0416M+OSW</span>
                </nav>
            </div>
                ...
                <div className="hero-card" style={mosaicBG(0.92)}>
                    <div className="hero-grid">
                        ...
                        <div className="hero-left">
                            <h1 className="hero-title">CATV EDFA CE0416M+OSW</h1>
                        ...
                        <div className="hero-right">
                            ...
                            >
                                <img loading="lazy" src={productImage} alt="CE0416M" />
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE0416M-OSW"
      /></div>
    );
};

export default Optronixedfaproducteleven;
