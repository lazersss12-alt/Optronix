...
import op08 from "../../../../assets/images/PE0819M.png";
...
const Optronixedfaproductfive = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix PE0819M PON EDFA | 8 Port 1550nm WDM Amplifier</title>
        <meta name="description" content="Optronix PE0819M: High-performance 8 port PON EDFA with built-in WDM for combining CATV & OLT signals. Features SNMP management and 19.5dBm output." />
        <meta name="keywords" content="Optronix PE0819M, PON EDFA, WDM EDFA, 8 Port EDFA, 1550nm Optical Amplifier, CATV EDFA, FTTH Amplifier, SNMP EDFA, Optronix India." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">PON EDFA PE0819M</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">PON EDFA PE0819M</h1>
            ...
            <div className="hero-right">
              ...
              >
                <img loading="lazy" src={productImage} alt="PE0819M" />
              </div>
            </div>
          </div>
        </div>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE0819M PON EDFA"
      /></div>
  );
};

export default Optronixedfaproductfive;
