...
const Optronixedfaproductthirteen = () => {
  ...
  const [enquireOpen, setEnquireOpen] = useState(false);
    ...
    return (
        <div className="s1v-page">
            <Helmet>
                <title>Optronix CE0819M-OSW | 8 Port 1550nm EDFA with Optical Switch</title>
                <meta name="description" content="Optronix CE0819M-OSW: 1550nm CATV EDFA with 8 ports, 19.5dBm output, and integrated Optical Switch. Features SNMP, redundant power, and low noise for FTTH." />
                <meta name="keywords" content="Optronix CE0819M-OSW, EDFA with Optical Switch, 8 Port EDFA, 1550nm Optical Amplifier, 19.5dBm EDFA, CATV EDFA, SNMP EDFA, Optronix India, Fiber Amplifier." />
            </Helmet>
            {/* Breadcrumbs */}
            <div className="container">
                <nav className="breadcrumb">
                    ...
                    <span className="current">CATV EDFA CE0819M+OSW</span>
                </nav>
            </div>
                ...
                <div className="hero-card" style={mosaicBG(0.92)}>
                    <div className="hero-grid">
                        ...
                        <div className="hero-left">
                            <h1 className="hero-title">CATV EDFA CE0819M+OSW</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE0819M-OSW"
      /></div>
    );
};

export default Optronixedfaproductthirteen;
