...
import op08 from "../../../../assets/images/PE1619M.png";
  ...
  const [enquireOpen, setEnquireOpen] = useState(false);
    ...
    return (
        <div className="s1v-page">
            <Helmet>
                <title>Optronix PE1619M-OSW PON EDFA | 16 Port Amplifier with Optical Switch</title>
                <meta name="description" content="Optronix PE1619M-OSW: 16 port PON EDFA with integrated WDM and Optical Switch. 19.5dBm output, SNMP/Web management, and low noise figure." />
                <meta name="keywords" content="Optronix PE1619M-OSW, PON EDFA with Optical Switch, 16 Port EDFA, 1550nm Amplifier, WDM EDFA, CATV EDFA, SNMP EDFA, Optronix India." />
            </Helmet>
            {/* Breadcrumbs */}
            <div className="container">
                <nav className="breadcrumb">
                    ...
                    <span className="current">PON EDFA PE1619M+OSW</span>
                </nav>
            </div>
                ...
                <div className="hero-card" style={mosaicBG(0.92)}>
                    <div className="hero-grid">
                        ...
                        <div className="hero-left">
                            <h1 className="hero-title">PON EDFA PE1619M+OSW</h1>
                        ...
                        <div className="hero-right">
                            ...
                            >
                                <img loading="lazy" src={productImage} alt="PE1619M" />
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE1619M-OSW PON EDFA"
      /></div>
    );
};

export default Optronixedfaproductnine;
