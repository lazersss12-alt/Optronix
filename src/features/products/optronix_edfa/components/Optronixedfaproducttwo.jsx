...
import op08 from "../../../../assets/images/CE0419M.png";
...
const Optronixedfaproducttwo = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix CE0419M 1550nm CATV EDFA | 4 Port 19.5dBm Amplifier</title>
        <meta name="description" content="Optronix CE0419M: High-performance 1550nm CATV EDFA with 4 ports and 19.5dBm output. Features SNMP management, redundant power supply, and low noise for FTTH." />
        <meta name="keywords" content="Optronix CE0419M, 19.5dBm EDFA, CATV EDFA, 4 Port Optical Amplifier, 1550nm EDFA, Optronix India, Fiber Optic Amplifier, SNMP EDFA, CATV Headend Equipment." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">CATV EDFA CE0419M</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">CATV EDFA CE0419M</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix CE0419M 1550nm CATV EDFA"
      /></div>
  );
};

export default Optronixedfaproducttwo;
