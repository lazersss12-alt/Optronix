...
const Optronixedfaproductsix = () => {
  ...
  return (
    <div className="s1v-page">
      <Helmet>
        <title>Optronix PE1619M PON EDFA | 16 Port 1550nm WDM Amplifier</title>
        <meta name="description" content="Optronix PE1619M: 16 port PON EDFA with integrated WDM for CATV and OLT integration. 19.5dBm output per port, SNMP management, and low noise." />
        <meta name="keywords" content="Optronix PE1619M, 16 Port PON EDFA, WDM EDFA, 1550nm Optical Amplifier, CATV EDFA, FTTH Solutions, SNMP EDFA, Optronix India, Fiber Optic Amplifier." />
      </Helmet>
      {/* Breadcrumbs */}
      <div className="container">
        <nav className="breadcrumb">
          ...
          <span className="current">PON EDFA PE1619M</span>
        </nav>
      </div>
        ...
        <div className="hero-card" style={mosaicBG(0.92)}>
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 className="hero-title">PON EDFA PE1619M</h1>
      ...
      <ProductLeadModal
        ...
        pageName="Optronix PE1619M PON EDFA"
      /></div>
  );
};

export default Optronixedfaproductsix;
